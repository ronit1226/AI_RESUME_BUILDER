...
import { Mail, User, PhoneOffIcon, BriefcaseBusiness, Linkedin, Globe, MapPin } from 'lucide-react'
...
const PersonalInfoForm = ({ data, onChange, removeBackground, setRemoveBackground }) => {
    ...
    const fields = [
        ...
        { key: 'phone', label: 'Phone Number', icon: PhoneOffIcon, type: "tel", required: true },
